...
joblib.dump(vectorizer.vocabulary_,'chapter5/vocabulary_.joblib')
...
X_train.to_csv('chapter5/train.feature.txt',sep='\t',index=False,header=None)
X_valid.to_csv('chapter5/valid.feature.txt',sep='\t',index=False,header=None)
X_test.to_csv('chapter5/test.feature.txt',sep='\t',index=False,header=None)
